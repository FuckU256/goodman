...
bot = telebot.TeleBot("1363143870:AAGdcwSC1gEDl6OEklWoDaa9lAH4w7urKOE")
...
def bunda(message1):
            ...
            if ideee in lib:
                ...
                bot.reply_to(message1,
                             '<b>' + '✅ Adquira acesso com meu Dono @FuckU256✅' + '</b>',
                             parse_mode='HTML')
